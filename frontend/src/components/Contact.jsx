export default function Contact() {
  const phone = <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#b94813" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" >
    <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" />
    <path d="M15 6l2 2l4 -4" />
  </svg> ;
  const direccion = <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#b94813" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" >
      <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
      <path d="M12 17l-1 -4l-4 -1l9 -4z" />
    </svg>;
  const meta = <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#b94813" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" >
  ...
  const facebook = <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 21" fill="none" stroke="#160be0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" >
      <path d="M18 2h-3a5 5 0 0 0 -5 5v3h-3v4h3v8h4v-8h3.642l.358 -4h-4v-2a1 1 0 0 1 1 -1h3z" />
    </svg>;
  const instagram = <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 19" fill="none" stroke="#6427a5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" >
